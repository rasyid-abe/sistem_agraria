...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form-add-subyek" action="<?php echo base_url() ?>terkait_subyek/action_edit" method="post">
                    <input type="hidden" name="id" value="<?php echo $query->subyek_id ?>">
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Nama</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" name="nama_pemilik" class="form-control" value="<?php echo $query->subyek_nama; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                            <input type="text" placeholder="RT" name="rt" class="form-control" value="<?php echo $query->subyek_rt ?>">
                        </div>
                        <div class="col-sm-4 col-lg-3">
                            <input type="text" placeholder="RW" name="rw" class="form-control" value="<?php echo $query->subyek_rw ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Jalan</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" name="jalan" class="form-control" value="<?php echo $query->subyek_jalan ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Nomor KTP</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="number" name="nomor_ktp" class="form-control" value="<?php echo $query->subyek_nomor_ktp ?>" min="1" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Pekerjaan</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" name="pekerjaan" class="form-control" value="<?php echo $query->subyek_pekerjaan ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Umur</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="number" name="umur" class="form-control" value="<?php echo $query->subyek_umur ?>" min="1" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="status_perkawinan" class="custom-control-input" value="1" <?php if($query->subyek_status_perkawinan == 1) {echo "checked";}?>><span class="custom-control-label">Belum Menikah</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="status_perkawinan" class="custom-control-input" value="2" <?php if($query->subyek_status_perkawinan == 2) {echo "checked";}?>><span class="custom-control-label">Menikah</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="status_perkawinan" class="custom-control-input" value="3" <?php if($query->subyek_status_perkawinan == 3) {echo "checked";}?>><span class="custom-control-label">Pernah Menikah</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="number" name="anggota_keluarga" class="form-control" value="<?php echo $query->subyek_jumlah_anggota_keluarga ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <label class="custom-control custom-radio">
                                <input type="radio" name="domisili" class="custom-control-input" value="1" <?php if($query->subyek_domisili == 1) {echo "checked";}?> onchange="change_domisili()"><span class="custom-control-label">Desa Ini</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="domisili" class="custom-control-input" value="2" <?php if($query->subyek_domisili == 2) {echo "checked";}?> onchange="change_domisili()"><span class="custom-control-label">Desa Lain Berbatasan Langsung</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="domisili" class="custom-control-input" value="3" <?php if($query->subyek_domisili == 3) {echo "checked";}?> onchange="change_domisili()"><span class="custom-control-label">Desa Lain Tidak Berbatasan Langsung</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="domisili" class="custom-control-input" value="4" <?php if($query->subyek_domisili == 4) {echo "checked";}?> onchange="change_domisili()"><span class="custom-control-label">Diluar Kecamatan</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="domisili" class="custom-control-input" value="5" <?php if($query->subyek_domisili == 5) {echo "checked";}?> onchange="change_domisili5()"><span class="custom-control-label">Lainnya</span>
                            </label>
                            <input type="<?php echo $query->subyek_domisili != 5 ? 'hidden' : 'text'; ?>" name="domisili_lainnya" placeholder="Masukkan Domisili Lainnya" id="domisili_lainnya" class="form-control" value="<?php echo $query->subyek_domisili_lainnya ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Memiliki Tanah Sejak Tahun</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="number" name="tahun_milik" class="form-control" value="<?php echo $query->subyek_tahun_memiliki_tanah ?>" required>
                        </div>
                    </div>
