...
<div class="dashboard-short-list">
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 co-12">
            <a href="<?php echo base_url() ?>user/edit_data/<?php echo $this->session->userdata('user_id') ?>" class="btn btn-sm btn-primary mybtn">Ubah Data</a>
            <a href="<?php echo base_url() ?>user/edit_password/<?php echo $this->session->userdata('user_id') ?>" class="btn btn-sm btn-dark mybtn">Ubah Password</a>
            <section class="card card-fluid">
                <h5 class="card-header drag-handle"> Profil Saya </h5>
