                ...
                if ($query_administrator_privilege->num_rows() > 0) {
                    ...
                    foreach ($query_administrator_privilege->result() as $row_administrator_privilege) {
                        ...
                        if ($row_administrator_privilege->administrator_menu_link != '#') {
                            $explode_link = explode('/', $row_administrator_privilege->administrator_menu_link);
                            $arr_menu['service_' . $row_administrator_privilege->administrator_menu_id] = $explode_link[0] . '/service/' . $explode_link[1] . '_service';
                        }
                    }
                }
